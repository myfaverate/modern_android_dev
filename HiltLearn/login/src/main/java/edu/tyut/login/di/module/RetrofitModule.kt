package edu.tyut.login.di.module
...
import edu.tyut.login.BuildConfig
import edu.tyut.login.data.remote.service.LoginService
import edu.tyut.login.utils.Constants
...
internal class RetrofitModule {
    ...
    @Provides
    @Singleton
    internal fun providerLoginService(retrofit: Retrofit): LoginService =
